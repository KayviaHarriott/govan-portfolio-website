...
export const Footer = () => {
  const team = [
    { label: "Jey Kim", url: "https://www.linkedin.com/in/je-yeon-kim-5a26a2192/" },
    { label: "Kenneth Williams Jr.", url: "https://www.linkedin.com/in/kenneth-williams-dev/" },
    ...
    <div className="bg-[#37474F] flex justify-center py-[48px] px-[120px]">
      <div className="w-[100%] max-w-[1200px] flex flex-col gap-[48px]">
          <div className="flex justify-between">
           <div>   <img className="w-[86px]" src={"/images/GovanLogo_Square.png"} /></div>
          ...
          <footer className="flex justify-between text-[14px] font-[600]">
            ...
            <p className="text-[#B0BEC5]">Last updated on May 30, 2024, 12:35 AM EST</p>
          </footer>
      </div>
    </div>
  );
